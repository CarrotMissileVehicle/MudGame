...
namespace mud::tool
{
    ...
    const ToolConfig kToolConfigs[3] = {
        { ToolId::Hoe,     "锄头", 50, 1, 5, {10, 30}, {"wood", "stone"}, {2, 3}, "黯铁矿", 2, 50 },
        { ToolId::Rod,     "鱼竿", 40, 1, 5, {10, 30}, {"wood", "stone"}, {2, 3}, "星纹银", 2, 80 },
        { ToolId::Pickaxe, "矿镐", 20, 1, 5, {10, 30}, {"wood", "stone"}, {2, 3}, "黯铁矿", 2, 80 },
    };
